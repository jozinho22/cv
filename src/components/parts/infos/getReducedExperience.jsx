...
const getReducedExperience = () => {
    
    return {
                french: [
                    {
                        period: "juin 2021 - septembre 2023",
                    ...
                    {
                        domains: [EnumDomain.MATHS],
                        period: "avril 2013 - septembre 2014",
                        company: "Enertrag - Cergy",
                        companyLink: "https://france.enertrag.com/",
                        as: "Cartographe dans le domaine des EnR (stages de M1/M2)"
                    },
                    {
                        domains: [EnumDomain.MATHS],
                    ...
                    },
                    {
                        ...
                        as: "Rédacteur technique dans le domaine de la mobilité durable (stage de L3)"
                    },
                    {
                        period: "pause",
                ...
                english: [
                    ...
                    },
                    {
                        ...
                        company: "Enertrag - Cergy",
                        companyLink: "https://france.enertrag.com/",
                        as: "Cartographer on the topic of renewables energies (M1/M2 internships)"
                    },
                    {
                        domains: [EnumDomain.MATHS],
                        company: "Sermet - Créteil",
                    ...
                    },
                    {
                        ...
                        company: "Planète verte - Paris",
                        companyLink: "http://www.planete-verte.fr/",
                        as: "Technical writer on the topic of sustainable development (stage de L3)"
                    },
                    {
                        period: "pause",
...
export default getReducedExperience;