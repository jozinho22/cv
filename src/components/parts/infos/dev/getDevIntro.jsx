const getDevIntro = () => {
        ...
        return  {
                        french: {
                                profession: "Développeur polyvalent",
                        ...
                        english: {
                                ...
                                summary: "Fullstack developer, looking for a new challenge. I love teamworking and solidarity mindset. Mathematics teacher for students as well, I'm fond of transmission and sharing".split('.')           
                        }
                } 
}
